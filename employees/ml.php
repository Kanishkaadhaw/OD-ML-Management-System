<?php
    ...
    header('location:../index.php');
        ...
        // Check if an image file was uploaded successfully
            ...
            if ($error === 0) {
                {
                    ...
                    else 
                    {
                        ...
                        header("Location: ml.php?error=$em");
                    }
                }
            }else {
        ...
        {
            // Handle error if no image was uploaded or an error occurred during upload
        ...
        $sql="INSERT INTO tblleaves(LeaveType, ToDate, FromDate, Description, Status, IsRead, empid,image_url) VALUES (:leavetype, :fromdate, :todate, :description, :status, :isread, :empid,:new_img_name)";
...
<head>
    ...
    <title>Student OD/ML Management System</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="leave.php" aria-expanded="true"><i class="ti-user"></i><span>Apply Ordinary Leave
                                    </span></a>
                            </li>

                            <li class="active">
                                <a href="ml.php" aria-expanded="true"><i class="ti-user"></i><span>Apply Medical Leave / OD
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Apply For Medical Leave / OD</h4>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">OD / ML Leave Form</h4>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Upload Your Proof Here</label>
                                            <input class="form-control-file" type="file" name="my_image" accept="image/*">
                                        </div>
