<?php
    ...
    header('location:../index.php');
        ...
        $sql="INSERT INTO tblleaves(LeaveType, ToDate, FromDate, Description, Status, IsRead, empid, Image) VALUES (:leavetype, :fromdate, :todate, :description, :status, :isread, :empid, :image)";
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="ml.php" aria-expanded="true"><i class="ti-user"></i><span>Apply Medical Leave
                                    </span></a>
                            </li>

                            <li class="active">
                                <a href="od.php" aria-expanded="true"><i class="ti-user"></i><span>Apply OD
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Apply For OD</h4>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">OD Leave Form</h4>
